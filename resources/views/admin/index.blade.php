...
<div id="main">
    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="login">
            ...
            <a href="{{ URL::to('/') }}"><img src="{{ URL::asset('upload/'.getcong('site_logo')) }}" style="height: 90px;" alt="logo"></a>
            </div>
               ...
               <!-- <div class="avatar">
				...
				<span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="form-group margin-none">
                            <div class="media">
                                ...
                                <div class="media-right media-middle">
                                    <a href="{{ URL::to('admin/password/email') }}" class="small pull-right">Recordar?</a>
                                </div>
                            </div>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary">Ingresar <i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!}
            </div>
