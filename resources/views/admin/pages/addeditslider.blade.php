...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($slide->name) ? 'Editar: '. $slide->name : 'Añadir Imágen' }}</h2>

		<a href="{{ URL::to('admin/slider') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Atrás</a>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" value="{{ isset($slide->name) ? $slide->name : null }}" class="form-control">
								...
								<div class="form-group">
										<label for="" class="col-sm-3 control-label">Texto</label>
										<div class="col-sm-9">
											<textarea  name="text" class="form-control summernote" rows="3">{{ isset($slide->text) ? $slide->text : null }}</textarea>
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($slide->name) ? 'Editar Imágen' : 'Añadir Imágen' }}</button>
