...
<div id="main">
	<div class="page-header">
      ...
      <a href="{{URL::to('admin/credits/addcredit')}}" class="btn btn-primary">Añadir Crédito  <i class="fa fa-plus"></i></a>
		</div><br>
		<h2>Créditos</h2>
	</div>
               ...
               @if($credits->type==7) <td>Microcrédito</td> @endif
                ...
                <div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-right" role="menu">
									<li><a href="{{ url('admin/credits/edit/'.$credits->id) }}"><i class="md md-edit"></i> Editar</a></li>
									<li><a href="{{ url('admin/credits/delete/'.$credits->id) }}"><i class="md md-delete"></i> Eliminar</a></li>
								</ul>
							</div>
