...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation">
            <a href="#careers_with_us" aria-controls="careers_with_us" role="tab" data-toggle="tab">Creditos</a>
        </li>

				<li role="presentation">
						<a href="#commissions" aria-controls="commissions" role="tab" data-toggle="tab">Comisiones</a>
				</li>
    ...
    <div class="tab-content tab-content-default">
        ...
        <div role="tabpanel" class="tab-pane" id="careers_with_us">
            ...
            {!! Form::close() !!}
				...
				<div role="tabpanel" class="tab-pane" id="commissions">

						{!! Form::open(array('url' => 'admin/comissions','class'=>'form-horizontal padding-15','name'=>'commissions_form','id'=>'commissions_form','role'=>'form')) !!}


								<div class="form-group">

										<label for="" class="col-sm-3 control-label">Comisión de personas directas</label>
										<div class="col-sm-1">
												<input type="text" name="direct_commission" value="{{ $settings->direct_commission }}" class="form-control" value="">
										</div>
								...
								<div class="form-group">
										...
										<label for="" class="col-sm-3 control-label">Comisión de personas indirectas</label>
										<div class="col-sm-1">
												<input type="text" name="indirect_commission" value="{{ $settings->indirect_commission }}" class="form-control" value="">
										</div>
										<label for="" class="col-sm-1 control-label">%</label>
