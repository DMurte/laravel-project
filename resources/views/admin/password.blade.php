...
<div id="main">
    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="login">
            ...
            <img src="{{ URL::asset('upload/'.getcong('site_logo')) }}" alt="logo" style="height: 70px;">
            </div>
...
<span aria-hidden="true">&times;</span></button>
				...
				@endif
                        ...
                        <div class="form-group">
                            <label for="email">Reestablecer password</label>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary"> Enviar Correo<i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!}
            </div>
