...
<div class="page-head">
  <h2 class="page-head-title">{{ isset($property->property_name) ? 'Editar: '. $property->property_name : 'Añadir Inmueble' }}</h2>
  <ol class="breadcrumb">
	...
	@endif
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(array('url' => array('app/addeditproperty'),'class'=>'form-horizontal padding-15','name'=>'property_form','id'=>'property_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="hidden" name="property_slug" value="{{ isset($property->property_slug) ? $property->property_slug : null }}" class="form-control">
				...
				<div class="form-group">
                    <label for="" class="col-sm-2 control-label">Proposito</label>
                    <div class="col-sm-5">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="hidden" name="brick_price" value="{{ isset($property->brick_price) ? $property->brick_price : null }}" class="form-control" placeholder="10000">

                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Caracteristicas</label>
                    <div class="col-sm-10">
				...
				<div class="form-group">
		                    ...
		                    <label for="usertype" class="col-sm-2 control-label">Ciudad</label>
		                     <div class="col-sm-5">
				...
				<div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">Imágen</label>
                    <div class="col-sm-10">
                        <div class="media">
				...
				<div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">Imágen 1</label>
                    <div class="col-sm-10">
                        <div class="media">
                            <div class="media-left">
				...
				<div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">Imágen 2</label>
                    <div class="col-sm-10">
                        <div class="media">
                            <div class="media-left">
				...
				<div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">Imágen 3</label>
                    <div class="col-sm-10">
                        <div class="media">
                            <div class="media-left">
				...
				<div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">Imágen 4</label>
                    <div class="col-sm-10">
                        <div class="media">
                            <div class="media-left">
				...
				<div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">Imágen 5</label>
                    <div class="col-sm-10">
                        <div class="media">
                            <div class="media-left">
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary btn-lg">{{ isset($property->property_name) ? 'Editar inmueble' : 'Añadir inmueble' }}</button>
