...
class PropertiesController extends MainAdminController
{
    ...
    public function index()
    {
        ...
        return view('app.pages.properties',compact('propertieslist'));
    }
	 ...
	 public function addeditproperty()
	 {
        ...
        return view('app.pages.addeditproperty',compact('city_list','types'));
    }
    ...
    $property->status = '0';
		...
		$property->brick_price = $inputs['brick_price'];
   ...
   $property->save();
		...
		if(!empty($inputs['id'])){
            ...
            \Session::flash('flash_message', 'Cambios Guardados, esperando aprobacion');

            return \Redirect::back();
        }else{

            \Session::flash('flash_message', 'Inmueble Añadido, esperando aprobacion');
    ...
    public function editproperty($id)
    {
          ...
          return view('app.pages.addeditproperty',compact('property','city_list','types'));
