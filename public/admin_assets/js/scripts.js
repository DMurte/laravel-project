 ...
 * To filter upon a specific key it needs to be hooked up in the filter section
 ...
 {
 id: '{{ index() }}',
 address: '{{integer(100, 999)}} {{street()}}, {{integer(100, 10000)}}',
 city: '{{city()}}',
 state: '{{ state() }}',
 price: '{{floating(1000, 4000, 2, "$0,0.00")}}',
 type: function (idx) {
 var choices = ['House', 'Apartment', 'Vila'];
 return choices[idx.integer(0, choices.length - 1)];
 },
 title: function (idx) {
 var choices = ['3 Beedrom', 'Luxury', '1 Bedroom', 'Family', '2 Bedroom', 'Spacious', 'Cheap'];
 return choices[idx.integer(0, choices.length - 1)] + ' ' + this.type  +' in ' + this.city;
 },
...
var propertiesData =
    [
        {
            "id": 0,
            "address": "207 Williams Avenue, 5985",
            "city": "Blandburg",
            "state": "Pennsylvania",
            "price": "2351.02",
            "type": "Apartment",
            ...
            "title": "Cheap Apartment in Blandburg",
            "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            "lat": 40.6870075,
            "lng": -78.4108512,
            "images": [
                'images/house.jpg',
            ...
            "created_at": "2014-11-06T13:06:21 -02:00"
        },
        {
            "id": 1,
            "address": "290 Ruby Street, 759",
            "city": "Florence",
            ...
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "3 Beedrom Vila in Florence",
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            "lat": 34.1954331,
            "lng": -79.7625625,
            "images": [
            ...
            "created_at": "2014-10-05T22:25:20 -03:00"
        },
        {
            "id": 2,
            "address": "666 Moultrie Street, 8249",
            "city": "Ogema",
            "state": "Saskatchewan",
            "price": "1,911.68",
            "type": "House",
           ...
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            ...
            "created_at": "2014-11-01T09:43:27 -02:00"
        },
        {
            "id": 3,
            "address": "396 Jamaica Avenue, 3716",
            "city": "Olney",
            ...
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "Cheap Apartment in Olney",
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            "lat": 39.1531627,
            "lng": -77.066923,
            "images": [
            ...
            "created_at": "2015-03-12T03:07:53 -02:00"
        },
        {
            "id": 4,
            "address": "660 Conselyea Street, 9463",
            "city": "Salix",
            "state": "Iowa",
            "price": "2,450.17",
            "type": "Apartment",
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "2 Bedroom Apartment in Salix",
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            "lat": 42.3083253,
            "lng": -96.2878044,
            "images": [
            ...
            "created_at": "2015-01-05T18:50:50 -02:00"
        },
        {
            "id": 5,
            "address": "722 Radde Place, 3367",
            "city": "Wichita",
            "state": "Kansas",
            "price": "1,369.98",
            "type": "Apartment",
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "Cheap Apartment in Manila",
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            "lat": 37.688889,
            "lng": -97.336111,
            "images": [
            ...
            "created_at": "2014-10-16T05:58:04 -03:00"
        },
        {
            "id": 6,
            "address": "130 Union Avenue, 2615",
            "city": "Columbus",
            "state": "Nebraska",
            "price": "2,546.35",
            "type": "Apartment",
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "1 Bedroom Apartment in Greenbush",
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            ...
            "created_at": "2014-03-10T11:33:15 -02:00"
        },
        {
            "id": 7,
            "address": "629 Rock Street, 6173",
            "city": "Newry",
            "state": "Alaska",
            "price": "2,645.91",
            "type": "Vila",
           ...
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            ...
            "created_at": "2014-03-06T17:02:10 -02:00"
        },
        {
            "id": 8,
            "address": "806 Monroe Street, 8574",
            "city": "Condon",
            "state": "Oregon",
            "price": "2,713.13",
            "type": "Vila",
           ...
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            ...
            "created_at": "2014-11-10T14:06:17 -02:00"
        },
        {
            "id": 9,
            "address": "936 Wolcott Street, 5334",
            "city": "Steinhatchee",
            "state": "New Jersey",
            "price": "1,071.97",
            "type": "Apartment",
            ...
            "title": "Family Apartment in Steinhatchee",
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            "lat": 34.61084,
            "lng": -95.045135,
            "images": [
            ...
            "created_at": "2014-11-08T19:14:53 -02:00"
        },
        {
            "id": 10,
            "address": "551 Fanchon Place, 9274",
            "city": "Muir",
            "state": "Florida",
            "price": "2,141.47",
            "type": "House",
           ...
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            ...
            "created_at": "2014-01-07T02:49:20 -02:00"
        },
        {
            "id": 11,
            "address": "513 Martense Street, 3287",
            "city": "Irwin",
            "state": "Palau",
            "price": "3,394.70",
            "type": "House",
           ...
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            ...
            "created_at": "2014-08-15T21:25:09 -03:00"
        },
        {
            "id": 12,
            "address": "577 Franklin Street, 9457",
            "city": "Matheny",
            "state": "Maine",
            "price": "1,836.26",
            "type": "House",
           ...
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            ...
            "created_at": "2014-11-07T05:34:47 -02:00"
        },
        {
            "id": 13,
            "address": "540 Prince Street, 3847",
            "city": "Trail",
            "state": "Missouri",
            "price": "2,983.64",
            "type": "Vila",
           ...
           "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aspernatur, at autem blanditiis cumque facere harum illum impedit modi nobis quas quod recusandae repellat reprehenderit sapiente velit vero vitae!",
            ...
            "created_at": "2014-01-09T19:57:09 -02:00"
        },
        {
            "id": 14,
            "address": "810 Clifton Place, 9037",
            "city": "Weeksville",
            "state": "Virginia",
            "price": "3,931.69",
            "type": "Apartment",
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "Family Apartment in Weeksville",
            "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, mollitia.",
            "lat": 37.866889,
            "lng": -110.70513,
            "images": [
                'images/house.jpg',
            ...
            "created_at": "2014-03-13T03:54:48 -02:00"
        },
        {
            "id": 15,
            "address": "592 Schenck Street, 5575",
            "city": "Gwynn",
            "state": "Kentucky",
            "price": "3,186.46",
            "type": "Apartment",
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "Cheap Apartment in Gwynn",
            "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, mollitia.",
            "lat": 33.322075,
            "lng": -94.162578,
            "images": [
            ...
            "created_at": "2014-08-09T14:24:58 -03:00"
        },
        {
            "id": 16,
            "address": "225 Stuart Street, 6179",
            "city": "Turah",
            "state": "Massachusetts",
            "price": "1,463.52",
            "type": "Vila",
            ...
            "created_at": "2014-05-09T02:40:01 -03:00"
        },
        {
            "id": 17,
            "address": "554 Terrace Place, 7673",
            "city": "Brownlee",
            "state": "Alabama",
            "price": "1,757.69",
            "type": "Vila",
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "Spacious Vila in Brownlee",
            "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, mollitia.",
            "lat": 38.285865,
            "lng": -105.776524,
            "images": [
            ...
            "created_at": "2014-05-09T17:33:13 -03:00"
        },
        {
            "id": 18,
            "address": "942 Campus Place, 2747",
            "city": "Shindler",
            "state": "Wisconsin",
            "price": "3,820.00",
            "type": "House",
            ...
            "created_at": "2015-01-17T04:19:47 -02:00"
        },
        {
            "id": 19,
            "address": "549 Vanderveer Street, 4531",
            "city": "Chestnut",
            "state": "North Dakota",
            "price": "2,691.21",
            "type": "House",
            "bedrooms": "3 Bedrooms",
            "bathrooms": "1 Bathroom",
            "title": "2 Bedroom House in Chestnut",
            "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, mollitia.",
            "lat": 39.194564,
            "lng": -100.808009,
            "images": [
            ...
            "created_at": "2015-02-27T21:47:26 -02:00"
        }
    ]
/*
 * The marker data will need to match this structre to work
